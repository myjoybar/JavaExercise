...
public class SolarTermsUtil2 {
    ...
    public SolarTermsUtil2(Calendar calendar) {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Date date = dateFormat1.parse("2017-12-22");

        today.setTime(date);
        SolarTermsUtil2 solarTermsUtil = new SolarTermsUtil2(today);
