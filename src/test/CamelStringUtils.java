...
/**
 * Created by joybar on 2017/12/7.
 */
public class CamelStringUtils {
    ...
    public static void main(String[] args) {
        ...
        String aaa1 = "appversionfld";

        String aaa2 = " post_module_data";
        System.out.println(underlineToCamel(aaa));
        System.out.println(underlineToCamel(aaa1));
        System.out.println(underlineToCamel(aaa2));
